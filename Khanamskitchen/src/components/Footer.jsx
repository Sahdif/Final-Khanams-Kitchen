  ...
  return (
    ...
    <div className="box-container">
        ...
        <div className="box">
            ...
            <div className="share">
                <a href="https://www.facebook.com/khanamskitchen" target='_blank' className="fab fa-facebook-f"></a>
            </div>
        </div>

        <div className="box">
            <h3>contact info</h3>
            <a className="links"> <i className="fas fa-phone"></i> 0450680199</a>
        ...
        <div className="box">
            ...
            <a href="#order" className="links"> <i className="fas fa-arrow-right"></i> Order </a>
        </div>
